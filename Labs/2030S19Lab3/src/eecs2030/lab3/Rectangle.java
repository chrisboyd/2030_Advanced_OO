...
public final class Rectangle implements Comparable<Rectangle> {
	...
	public int compareTo(Rectangle r) {
		...
		double difference = this.getArea() - r.getArea();
	...
	public boolean equals(Object obj) {
		if (obj == null || this.getClass() != obj.getClass())
			...
			double longest = Math.max(this.getWidth(), this.getHeight())
					- Math.max(((Rectangle) obj).getWidth(), ((Rectangle) obj).getHeight());

			double shortest = Math.min(this.getWidth(), this.getHeight())
					- Math.min(((Rectangle) obj).getWidth(), ((Rectangle) obj).getHeight());

			if (Math.abs(longest) < ShapeUtil.TOL && Math.abs(shortest) < ShapeUtil.TOL)
				return true;
		}
		return false;
	}

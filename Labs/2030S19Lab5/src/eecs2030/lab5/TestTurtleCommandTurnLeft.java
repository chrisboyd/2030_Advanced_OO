...
public class TestTurtleCommandTurnLeft {
	...
	public void test01_getTurtle() {
		Turtle t = new Turtle();
		TurtleCommand c = new TurtleCommandTurnLeft(t, 55.0);
	...
	public void test02_execute() {
		...
		TurtleCommand c = new TurtleCommandTurnLeft(t, 55.0);
		c.execute();
		assertEquals("execute did not turn the turtle left by the correct angle",
				80.5, dir.getAngle(), 1e-8);
	}

	@Test
	public void test03_execute() {
		Turtle t = new Turtle();
		TurtleCommand c = new TurtleCommandTurnLeft(t, 25.0);
		Turtle u = new Turtle(0.1, 0.1, 25.5, Color.BLACK);
		Direction2 dir = u.leakDirection();
		c.execute(u);
		assertEquals("execute did not turn the turtle left by the correct angle",
				50.5, dir.getAngle(), 1e-8);
	}

	@Test
	public void test04_getDelta() {
		Turtle t = new Turtle(0.1, 0.1, 25.5, Color.BLACK);
		TurtleCommandTurnLeft c = new TurtleCommandTurnLeft(t, 55.0);
